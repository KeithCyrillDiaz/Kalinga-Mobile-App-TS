...
import { BigTextInputQuestions, MedicalHistoryQuestionsForDonor, YesOrNoQuestions } from "@/data/devData";
...
interface ScreeningFormPage3Props {
    savedData: ScreeningFormType;
    userType: string;
}


export const ScreeningFormPage3: React.FC<ScreeningFormPage3Props> = ({
    savedData,
    userType,
}) =>{
    ...
    const {
        ...
        validForm
    } = useScreeningForm({userType: userType, savedData, pageNumber: 3})
    console.log("Data in Screening form page 3: ", JSON.stringify(savedData, null, 2))
